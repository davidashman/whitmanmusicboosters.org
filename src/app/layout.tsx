...
export const metadata: Metadata = {
  ...
  description:
    "Support music education and performance opportunities for Whitman students. Make a tax-deductible donation to help fund instruments, sheet music, and performance experiences.",
  keywords:
    "Whitman Music, Music Boosters, Music Education, Donations, School Music",
  authors: [{ name: "Whitman Music Boosters" }],
  openGraph: {
    title: "Whitman Music Boosters",
    description:
      "Support music education and performance opportunities for Whitman students",
    type: "website",
  },
};
